...
#define MS100	20//25//((int) (100/MS_PER_SAMPLE + 0.5))
...
#define MS1500	300//275//((int) (1500/MS_PER_SAMPLE))
#define DERIV_LENGTH	2//2  //MS10
#define LPBUFFER_LGTH  10//12  //((int) (2*MS25))
#define HPBUFFER_LGTH  25//31  //MS125

#define WINDOW_WIDTH	16//20//MS80			// Moving window integration width.
#define	FILTER_DELAY  57//71 //(int) (((double) DERIV_LENGTH/2) + ((double) LPBUFFER_LGTH/2 - 1) + (((double) HPBUFFER_LGTH-1)/2) + PRE_BLANK)  // filter delays plus 200 ms blanking delay
#define DER_DELAY	93// WINDOW_WIDTH + FILTER_DELAY + MS100
